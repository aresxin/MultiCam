...
class MetalRenderer {
    ...
    func update(with ciImage: CIImage, rect: CGRect? = nil) {
        ...
        if let rect = rect {
            ...
            drawRect = ciImage.extent
        }

        ciContext.render(ciImage, to: currentDrawable.texture, commandBuffer: commandBuffer, bounds: drawRect, colorSpace: colorSpace)
